...
import quangnnfx16178.ilovevn.charity.CharityService;
...
public class ProjectController {
    ...
    public String deleteSingleProject(@PathVariable("id") Integer id, Model model, RedirectAttributes ra, HttpServletRequest request) {
        try {
            ...
            ProjectSaveHelper.deleteProjecImagesFolder(id, request.getSession().getServletContext().getRealPath("/"));
    ...
    public String deleteMultipleProjects(@RequestParam(name = "id") List<Integer> ids, Model model, RedirectAttributes ra, HttpServletRequest request) {
        try {
            ...
            ProjectSaveHelper.deleteProjecImagesFolders(ids, request.getSession().getServletContext().getRealPath("/"));
            ra.addFlashAttribute("success", true);
            ...
            )
    {
        ...
        try {
            ...
            ProjectSaveHelper.removeDeletedProjectImages(project, imageNames);
