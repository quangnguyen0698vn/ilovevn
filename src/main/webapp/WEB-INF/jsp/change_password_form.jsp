...
<body class="d-flex flex-column min-vh-100">
    ...
    <c:set var="postUri" value="/saveChangedPassword"></c:set>
        ...
        >
            <div class="border border-secondary rounded p-3">
                ...
                <div class="form-group row mb-3">
                    ...
                    <c:if test="${checkCorrectPassword != null}">
                        <p class="text-danger"><c:out value="${checkCorrectPasswordMessage}"></c:out></p>
                    </c:if>
                </div>
